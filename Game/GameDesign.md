...
- # 게임 기획의 요소
    ...
    - ## 게임의 구성요소
        ...
        3. 게임 기획자 - 아이디어와 비전 수준의 문장을 디자인으로 바꾸는 
        이러한 3가지의 요소를 고려해야한다. 
        그런데 만약 여기서 변수가 생긴다면?
...
- # 좋은 기획서를 만드는 법
    ...
    - ## 시각화의 장점
        ...
        방법? 스크린샷, 추상적인 컨셉아트 등 여러 방법이 있다
        시각화를 할 시, 작업의 효율을 올려주며, 작업의 속도와, 기획서에 대한 이해혁도 올려준다.
        ```
    - ## 간단명료하면서, 정확하게
        ```
        많고, 길고, 포괄적인 세부내용보단, 
        적고, 짧고, 정확히 명시되어진 세부내용이 훨씬 낫다. 
        읽기 더 쉬울 뿐만이 아닐더러, 다른 사람들이 기획서를 읽을때도 중심 내용을 더욱 파악하기 쉬워진다
        ```
    - ## 좋은 서식, 좋은 서체
