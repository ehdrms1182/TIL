...
- # 게임의 구성요소
    ...
    - ## 게임의 구성요소
        ...
        ```
            ...
            현 오버워치 디렉터이자,전 WOW 디렉터인 제프 카플란은 
            ...
            다른 예시를 들자면, 문명 시리즈를 플레이하며 지역을 알고, 문명의 발전들을 관찰하고,
            직접 시뮬레이션하며 얻는 지적인 만족감들도 보이지 않는 보상이라 할 수 있겠다.
...
- # 좋은 기획서를 만드는 법
    ...
    - #### 게임 컨셉 기획
        ```
        1. 게임의 전체적인 방향성과 비전을 설정한다.
        2. 플레이어에게 어떤 재미와 경험을 줄 것인지 생각한다.
        3. 한 문장으로 요약했을때, 어떠한 게임인지 고려해본다.
        4. 트렌디한 게임을 제작할지, 매니악한 게임을 제작해볼지 방향성을 정한다.
        ```
    - #### 게임 서비스 기획
        ```
        1. 수익 모델을 설정한다.
        2. 오픈 시기, 경쟁 타이틀 등 마케팅, 이벤트, 수익 배분등을 설정한다.
        3. 타겟으로 할 시장을 설정한다.
        ```
    ...
    - #### 게임 제작 계획
        ```
        1. 제작 설계
        - 마일스톤 및 중간 테스트 일정등을 미리 설정해둔다.
        - 콘텐츠 테스트 시기,시점을 계산한다.
        
        2. 인력 계획
        - 개발 조직 구성
        - 개발 마일스톤에 따라 인력 확충 계획을 세운다.
        - 아웃소싱을 염두에 두고 계획한다.

        3. 제작 프로세스 수립
        - 개발 과정, 프로세스와 목표를 수립한다.
        - 역량 파악을 토대로 개발 계획 일정을 조정한다.
        - 개발 과정 중 필요해질, 필요한 문서를 정의한다.
        - 개발자용 툴을 제작한다. (레벨디자인 등등)

        4. 배포 및 QA 프로세스 수립 
        - 형상 관리 도구 및 이슈 트래킹, 브랜치 구조 수립
        - 배포 도구 및 지속적 통합 도구 개발
        ```
        관련 링크 : [마일스톤](https://ko.wikipedia.org/wiki/%EB%A7%88%EC%9D%BC%EC%8A%A4%ED%86%A4_(%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8_%EA%B4%80%EB%A6%AC) "Link")
    - ### Production
        ```
